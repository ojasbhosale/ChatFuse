...
// Floating particle component (reused from hero)
...
// Animated gradient orb (reused from hero)
...
export default function CostSavingsSection() {
  ...
  return (
    <section className="relative py-16 sm:py-20 mt-4 lg:py-24 overflow-hidden bg-gradient-to-br from-red-50/30 via-orange-50/20 to-yellow-50/30">
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 sm:mb-20">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            ...
            <span className="text-red-600 font-bold text-xl sm:text-2xl md:text-3xl">
              $380+ every month
            </span>{" "}
            with one{" "}
            <span className="text-green-600 font-bold text-xl sm:text-2xl md:text-3xl">
              $15 plan
            </span>.
          </p>
        </div>

        {/* Comparison Grid - Equal Heights */}
                      ...
                      <div className="bg-white border-2 border-red-100 rounded-2xl p-8 shadow-xl shadow-red-500/5 hover:shadow-red-500/10 transition-shadow duration-300 h-full flex flex-col">
                        ...
                        <div className="text-center mb-8">
                          ...
                          <div className="text-5xl font-black text-red-600">
                            ...
                            <span className="text-2xl text-gray-500 font-semibold">/month</span>
                          </div>
                        </div>
                    ...
                    <div className="relative group">
                      ...
                      <div className="bg-white border-2 border-green-100 rounded-2xl p-8 shadow-xl shadow-green-500/5 hover:shadow-green-500/10 transition-all duration-300 h-full flex flex-col hover:scale-[1.01]">
                        ...
                        <div className="text-center mb-8">
                          ...
                          <div className="text-sm text-gray-500 line-through mt-1">normally $20/month</div>
                        </div>
                        ...
                        <div className="space-y-3 flex-grow">
                          ...
                          {/* Bonus Features */}
                          <div>
                            <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-3">Bonus Features</h4>
                            <div className='flex items-center justify-start gap-3 '>
                              <div  className="flex items-center gap-1">
                                ...
                                <span className="text-gray-700 font-medium">Project folders</span>
                              </div>
                              <div  className="flex items-center gap-1">
                                <div className="w-5 h-5 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center flex-shrink-0">
                                  <Sparkles className="text-white w-3 h-3" />
                        ...
                        <div className="mt-8 pt-6 border-t border-green-100">
                          <div className="text-center">
                            <div className="text-sm font-medium text-gray-500 mb-1">Monthly Savings</div>
      ...
      {/* Bottom fade */}
      <div className="absolute bottom-0 left-0 right-0 h-20 sm:h-32 bg-gradient-to-t from-white via-gray-50/30 to-transparent" />
    </section>
  )
}